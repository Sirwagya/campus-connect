...
DROP POLICY IF EXISTS "Team leaders can update members" ON public.team_members;
...
DROP POLICY IF EXISTS "Users can join/leave as members" ON public.team_members;
